function __InputConfigVerbs()
{
    ...
    InputDefineVerb(INPUT_VERB.A,  "a",     [vk_enter, "J"],            gp_face3);
    InputDefineVerb(INPUT_VERB.B, "b",    [vk_shift,  "K"],          gp_face4);
    InputDefineVerb(INPUT_VERB.PAUSE, "tab",    [vk_tab,  "I"],          gp_select);
    ...
    {
        InputDefineVerb(INPUT_VERB.ACCEPT, "accept", [vk_space, "J"],     gp_face1);
        InputDefineVerb(INPUT_VERB.CANCEL, "cancel", [vk_backspace, "K"], gp_face2);
    }
